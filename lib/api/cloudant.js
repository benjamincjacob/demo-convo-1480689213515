...
var botdb = process.env.INSTANCE == 'TEST' ? cloudant.db.use('botdb') : cloudant.db.use('demobotdb');
var chatlog = process.env.INSTANCE == 'TEST' ? cloudant.db.use('chatlog') : cloudant.db.use('demochatlog');
